...
//		rmSetLightingSet("st_louis");
        ...
        int avoidTownCenterSmall=rmCreateTypeDistanceConstraint("avoid Town Center small", "townCenter", 21.0);
...
//spawnSwitch = 0.1;
	...
	//*************ffa placement********
		rmPlacePlayersCircular(0.36, 0.36, 0.00);
	}
...
/*
	...
	//  	rmAddObjectDefConstraint(marshPlants, avoidCoinMed);	
	  //	rmAddObjectDefConstraint(marshPlants, avoidGold);	
		rmPlaceObjectDefAtLoc(marshPlants, 0, 0.5, 0.5, 24*cNumberNonGaiaPlayers);
*/
	int whaleLand = rmCreateTerrainDistanceConstraint("whale land", "land", true, 5.0);
		...
		rmPlaceObjectDefAtLoc(duckBoys, 0, 0.5, 0.5, 1.5*cNumberNonGaiaPlayers);
